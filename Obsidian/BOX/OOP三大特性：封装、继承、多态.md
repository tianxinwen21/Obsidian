...
- Java中主要通过类和访问权限来实现封装：**类可以将数据以及封装数据的方法结合在一起**，而**访问权限来控制方法或者字段能否直接在类外使用**。Java中提供了**四种**访问限定符：
- ![](https://photo-cloud-1314717058.cos.ap-nanjing.myqcloud.com/c/202212152045695.png)
